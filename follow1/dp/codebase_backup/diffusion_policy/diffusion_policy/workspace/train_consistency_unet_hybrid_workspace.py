...
from diffusion_policy.policy.consistency_unet_hybrid_image_policy import ConsistencyUnetHybridImagePolicy
...
class TrainConsistencyUnetHybridWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        # configure model
        self.model: ConsistencyUnetHybridImagePolicy = hydra.utils.instantiate(cfg.policy)

        self.ema_model: ConsistencyUnetHybridImagePolicy = None
...
def main(cfg):
    workspace = TrainConsistencyUnetHybridWorkspace(cfg)
    workspace.run()
